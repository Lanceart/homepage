...
developing applications in a collaborative team environment and strong analy tical and problem solving skills.
                ...
                <div className={styles.item}>
                    ...
                    <p>
                        Hello, I am <b className={styles.text_color}>Linqing</b>, or you can call me <b className={styles.text_color}>Cyan</b>. I am a graduate student in Computer Science interested in 💻 <b className={styles.text_color_golden}>Software Development</b> 🌐, 
